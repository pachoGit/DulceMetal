 ...
 * Presenta la manera basica de como gestionar las colisiones de
 * Box2D, identificando quienes estan colisionando
 */
...
int main()
{
    InitWindow(ANCHO, ALTO, "Raylib y Box2D - Detectando colision");
